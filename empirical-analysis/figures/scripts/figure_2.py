...
def camel(x):
    ...
    Bounds: x1 in [-3, 3] and x2 in [-2, 2]
            or
            x1 in [-2, 2] and x2 ind [-1, 1]
    """
...
plt.savefig("empirical-analysis/figures/Figure2.png")
plt.savefig("empirical-analysis/figures/Figure2.eps", format="eps")
plt.clf()
