...
def ei(func, noise, bounds, env_dims, num_starts, num_samples, evals, runs, stepsize, num_tests, eval_stepsize, cores, name, start_str, walk_str):
    # paths
    data_dir = f"empirical-analysis/results/{name}_ei/"
