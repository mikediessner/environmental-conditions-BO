...
eval_stepsize = 25                                           # increments of predictions
filename = "results/levy/observation-ei/observation-ei-levy" # filename for output csv files
...
# make plot
make_plot(maes, "results/plots/observation-ei-levy")
