...
# noise
ei(func, 0.025, bounds, dynamic_dims, num_starts, num_samples, evals, runs, stepsize, num_tests, eval_stepsize, cores, "hartmann_noisy_0.025", start_str, walk_str)
print("Noise 0.025 done.")

ei(func, 0.05, bounds, dynamic_dims, num_starts, num_samples, evals, runs, stepsize, num_tests, eval_stepsize, cores, "hartmann_noisy_0.05", start_str, walk_str)
print("Noise 0.05 done.")

ei(func, 0.1, bounds, dynamic_dims, num_starts, num_samples, evals, runs, stepsize, num_tests, eval_stepsize, cores, "hartmann_noisy_0.1", start_str, walk_str)
print("Noise 0.1 done.")


# multiple environmental conditions
ei(func, noise, bounds, [3, 5], num_starts, num_samples, evals, runs, [0.10, 0.05], num_tests, eval_stepsize, cores, "hartmann_multi_2", start_str, "2d")
print("2 environmental conditions done.")

ei(func, noise, bounds, [0, 3, 5], num_starts, num_samples, evals, runs, [0.10, 0.10, 0.05], num_tests, eval_stepsize, cores, "hartmann_multi_3", start_str, "3d")
print("3 environmental conditions done.")


# fluctuation
ei(func, noise, bounds, dynamic_dims, num_starts, num_samples, evals, runs, [0.1], num_tests, eval_stepsize, cores, "hartmann_stepsize_0.1", start_str, walk_str)
print("Fluctuation 0.1 done.")

ei(func, noise, bounds, dynamic_dims, num_starts, num_samples, evals, runs, [0.25], num_tests, eval_stepsize, cores, "hartmann_stepsize_0.25", start_str, walk_str)
print("Fluctuation 0.25 done.")

ei(func, noise, bounds, dynamic_dims, num_starts, num_samples, evals, runs, [0.5], num_tests, eval_stepsize, cores, "hartmann_stepsize_0.5", start_str, walk_str)
print("Fluctuation 0.5 done.")

ei(func, noise, bounds, dynamic_dims, num_starts, num_samples, evals, runs, [1.0], num_tests, eval_stepsize, cores, "hartmann_stepsize_1.0", start_str, walk_str)
print("Fluctuation 1.0 done.")


# parameter variability
ei(func, noise, bounds, [2], num_starts, num_samples, evals, runs, stepsize, num_tests, eval_stepsize, cores, "hartmann_variability_low", start_str, walk_str)
print("Low variability done.")

ei(func, noise, bounds, [0], num_starts, num_samples, evals, runs, stepsize, num_tests, eval_stepsize, cores, "hartmann_variability_high", start_str, walk_str)
