...
# set up experiment
func = Hartmann6D(minimise=False)     # objective function~@p;.0gfd4swq 
num_tests = 25                        # number of test points
eval_stepsize = 10                    # increments of predictions
runs = 30                             # number of replicaions
directory = "results/hartmann/ucb-8/" # directory path
filename = "ucb-8-hartmann"           # filename for output csv files
