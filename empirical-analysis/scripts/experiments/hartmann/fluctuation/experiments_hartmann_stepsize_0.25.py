...
directory = "data/hartmann/stepsize_0.25/" # directory path
filename = "hartmann_stepsize_0.25"        # filename for output csv files
stepsize = [0.25]                          # stepsize of random walk
