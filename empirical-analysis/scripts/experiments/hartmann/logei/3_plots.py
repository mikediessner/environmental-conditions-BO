...
filename = "results/hartmann/observation-logei/observation-logei-hartmann" # filename for output csv files
...
# make plot
make_plot(maes, "results/plots/observation-logei-hartmann")
