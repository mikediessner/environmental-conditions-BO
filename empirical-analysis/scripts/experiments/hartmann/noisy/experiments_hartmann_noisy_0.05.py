...
noise = 0.05                            # std of Gaussian noise added to func
...
directory = "data/hartmann/noisy_0.05/" # directory path
filename = "hartmann_noisy_0.05"        # filename for output csv files
