...
noise = 0.1                            # std of Gaussian noise added to func
...
directory = "data/hartmann/noisy_0.1/" # directory path
filename = "hartmann_noisy_0.1"        # filename for output csv files
