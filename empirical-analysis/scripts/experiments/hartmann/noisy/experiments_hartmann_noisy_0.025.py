...
noise = 0.025                            # std of Gaussian noise added to func
...
directory = "data/hartmann/noisy_0.025/" # directory path
filename = "hartmann_noisy_0.025"        # filename for output csv files
