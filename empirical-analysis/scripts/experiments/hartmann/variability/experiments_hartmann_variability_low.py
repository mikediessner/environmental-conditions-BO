...
dynamic_dims = [2]                           # list of indices for dynamic dimensions
...
directory = "data/hartmann/variability_low/" # directory path
filename = "hartmann_variability_low"        # filename for output csv files
