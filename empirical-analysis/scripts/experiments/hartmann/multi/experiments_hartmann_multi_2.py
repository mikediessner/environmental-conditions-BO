...
dynamic_dims = [3, 5]                # list of indices for dynamic dimensions
...
directory = "data/hartmann/multi_2/" # directory path
filename = "hartmann_multi_2"        # filename for output csv files
stepsize = [0.10, 0.05]              # stepsize of random walk
...
for run in range(runs):
    walk = np.loadtxt(f"data/random_walks/2d_random_walk_run{run+1}.csv", delimiter=",")
