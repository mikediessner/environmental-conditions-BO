...
def ei(func, noise, bounds, dynamic_dims, num_starts, num_samples, evals, runs, stepsize, num_tests, eval_stepsize, cores, name, start_str, walk_str):
    # paths
    data_dir = f"tests/{name}/"
    plot_dir = "tests/plots/"
    filename = f"observation-ei-{name}"
