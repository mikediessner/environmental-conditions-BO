...
def envbo_step(x_train, y_train, bounds, beta, x_dynamic, dynamic_dims, num_starts, num_samples):
...
def envbo_experiment(func, noise, bounds, beta, random_walk, dynamic_dims, num_starts, num_samples, evals, run, filename, stepsize, starts=None):
