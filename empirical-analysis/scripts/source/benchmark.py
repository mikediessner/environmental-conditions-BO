import torch
import numpy as np
from source.helper import make_header, update_dynamics
import json


def bm_experiment(func, noise, bounds, random_walk, dynamic_dims, num_starts, num_samples, evals, run, filename, stepsize, starts=None):
    ...
    for iter in range(evals-1):
        ...
        x_new[0, dynamic_dims] = x_dynamic
